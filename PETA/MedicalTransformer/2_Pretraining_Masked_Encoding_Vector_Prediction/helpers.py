...
# from pylab import rcParams # daba error 
...
def get_metric_multi(y, y_score):
    ...
    cmatrix = confusion_matrix(y, y_pred, labels=[0, 1])

    return auc, auprc, acc, balacc, sen, spec, prec, recall, cmatrix
...
def get_metric_binary(y, y_score):
    ...
    return auc, auprc, acc, balacc, sen, spec, prec, recall, f1, cmatrix
